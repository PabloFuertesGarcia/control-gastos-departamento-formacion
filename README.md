...
El sistema permitirá centralizar la gestión de costes asociados a los distintos programas, iniciativas y proveedores, facilitando el control de:* Gastos* Presupuestos* Facturas
...
#### 1. Base de Datos: 
Descargar un gestor de Base de Datos (PHPmyAdmin con MySQL) y ejecutar los scripts SQL de creación de la BD y las tablas de la carpeta /sql/ directamente.
...
Para instrucciones paso a paso sobre el entorno y la configuración, consultar el manual completo en:
 ...
 [*docs/sistemas/Informe Técnico de Entorno de Ejecución.pdf.*](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/blob/main/docs%2Fsistemas%2FInforme%20T%C3%A9cnico%20de%20Entorno%20de%20Ejecuci%C3%B3n.pdf)
...
* [Carpeta /diagrams:](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/tree/main/diagrams)
Diseño (Diagrama E/R), modelo relacional y README explicando el diseño.

* [Carpeta /sql:](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/tree/main/sql)
Los distintos scripts SQL de creación, inserción de datos y consultas de la aplicación.


#### Programación y MPO: 

* [Carpeta /src:](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/tree/main/src)
Código fuente Java de la aplicación, organizado por paquetes.

* README del proyecto - En la siguiente sección de este Readme se puede ver cómo se ha estructurado y el funcionamiento del código, y las mejoras implementadas para el módulo de MPO (marcadas como "******** MEJORA MPO - ")


#### Lenguajes de Marcas:

* [Carpeta /xml:](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/tree/main/xml)
Archivo de datos (.xml), esquema de validación (.xsd) y evidencias de validación del sistema.


#### Sistemas Informáticos:

* [Carpeta /docs/sistemas:](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/tree/main/docs%2Fsistemas)
Informe técnico del entorno de ejecución, requisitos de hardware y manual de instalación 


#### Itinerario Personal para la Empleabilidad I:

* [Carpeta /docs/empleabilidad:](https://github.com/PabloFuertesGarcia/control-gastos-departamento-formacion/tree/main/docs%2Fempleabilidad)
Perfil profesional, investigación del sector, presentación del proyecto y el portfolio básico.
